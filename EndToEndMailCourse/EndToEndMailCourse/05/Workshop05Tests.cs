...
namespace EndToEndMailCourse._05
{
    ...
    public class Workshop05Tests
    {
        ...
        public void ShouldSelectAnswers()
        {
            ...
            #region TEST
            var productQualitySelect = new SelectElement(qualityElement);
            productQualitySelect.SelectByText("Good");

            var supportQualitySelect = new SelectElement(supportElement);
            supportQualitySelect.SelectByIndex(0);
            #endregion
